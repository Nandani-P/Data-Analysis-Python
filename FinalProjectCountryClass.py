...
class Country(CountryBase):
    def __init__(self, name=0, year=0, lifeExpe=0, capInc=0, popDensity=0, HDI=0, demoScore=0, freedIndex=0, aggrRank=0, rankLE=0, rankPCI=0, rankPD=0, rankHDI=0, rankDS=0, rankFI=0):
